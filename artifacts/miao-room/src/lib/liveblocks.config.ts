...
const publicApiKey = import.meta.env.VITE_LIVEBLOCKS_PUBLIC_KEY || 'pk_dev_missing_key'
if (publicApiKey === 'pk_dev_missing_key' && typeof window !== 'undefined') {
  console.warn('[multiplayer] VITE_LIVEBLOCKS_PUBLIC_KEY is not set; running offline.')
}
